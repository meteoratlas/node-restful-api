...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXR1dW5xMSIsImEiOiJja2ExbjRsZGwwMmltM2VwaWY4cG9jcTJzIn0.pEmZJoNnf11WI20NQU6Gew';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // popup
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "http://127.0.0.1:3000/api/v1/users/updatePassword" : "http://127.0.0.1:3000/api/v1/users/updatecurrentuser";
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1), " updated successfully"));
            }
...
var accountUpdateSubmitBtn = document.querySelector('.form-user-data');
var formPassword = document.querySelector('.form-user-password');
...
if (accountUpdateSubmitBtn) {
  accountUpdateSubmitBtn.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (formPassword) {
  formPassword.addEventListener('submit', /*#__PURE__*/function () {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54363" + '/');
